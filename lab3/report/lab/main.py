...
def task():
    data1 = load_csv('data/Ch1_800nm_0.23mm.csv')
    data2 = load_csv('data/Ch2_800nm_0.23mm.csv')
    ...
    #plot data together 
    plt.plot(data_n, [data1[i][0] for i in range(len(data1))], label='Ch1_800nm_0.23mm.csv')
    plt.plot(data_n, [data2[i][0] for i in range(len(data2))], label='Ch2_800nm_0.23mm.csv')
    plt.legend()
    ...
    min1 = opt.root(countJaccar, 1)     
    max1 = opt.root(countJaccar, 1.15, method='lm')    
