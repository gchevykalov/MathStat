...
\begin{table}[H]
	\centering
	\input{lab/task1\_data/20.tex}
	\caption{Двумерное нормальное распределение, n = 20}
	\label{tab:n20}
\end{table}
\begin{table}[H]
	\centering
	\input{lab/task1\_data/60.tex}
	\caption{Двумерное нормальное распределение, n = 60}
	\label{tab:n60}
\end{table}
\begin{table}[H]
	\centering
	\input{lab/task1\_data/100.tex}
	\caption{Двумерное нормальное распределение, n = 100}
	\label{tab:n100}
\end{table}
\begin{table}[H]
	\centering
	\input{lab/task1\_data/mix.tex}
...
\begin{flushleft}
	\input{lab/task2\_data/no_noise.tex}
\end{flushleft}
\begin{figure}[H]
...
\begin{flushleft}
	\input{lab/task2\_data/noise.tex}
\end{flushleft}
\begin{figure}[H]
...
\begin{flushleft}
	...
	\begin{table}[H]
		\centering
		\input{lab/task3_data/task3_normal.tex}
	...
	\begin{table}[H]
		\centering
		\input{lab/task3_data/task3_laplace.tex}
